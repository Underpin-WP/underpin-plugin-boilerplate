...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/src/batch.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/js/src/batch.js":
/*!********************************!*\
  !*** ./assets/js/src/batch.js ***!
  \********************************/
/*! no exports provided */
...
$(document).ready(function () {
  ...
  $(notices).each(function () {
    ...
    var statusWrap = $(this).find('.status-wrap');
    var data = plugin_name_replace_me_batch[batchId];
    ...
    function task() {
      var tally = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      ...
      $.ajax({
        ...
        success: function success(response) {
          if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(response) === 'object' && undefined !== response.error) {
